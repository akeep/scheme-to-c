...
(library (c)
  ...
  ;;; pass: generate-javascript : L22 -> printed-output
  ;;;
  ;;; this pass takes a program in the L22 language and produces a
  ;;; printed JavaScript program.  using a string or file port, the
  ;;; results of this can be captured in a string or sent to a file to
  ;;; be executed.
  ;;;
  ;;; TODO: this pass is fairly convoluted, and could use some
  ;;;       refactoring.  We might also want to try to pretty-print
  ;;;       the JavaScript code so that it prints out a bit better.
  ;;;
